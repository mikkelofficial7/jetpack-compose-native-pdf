...
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.ResourceCache;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.common.PDRectangle;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.font.encoding.DictionaryEncoding;
...
public class PDType3Font extends PDSimpleFont
{
    ...
    protected final void readEncoding() throws IOException
    {
        ...
        if (encodingBase instanceof COSName)
        {
            ...
            if (encoding == null)
            {
                Log.w("Pdf-Decryptor", "Unknown encoding: " + encodingName.getName());
            }
        }
    ...
    private BoundingBox generateBoundingBox()
    {
        ...
        if (rect == null)
        {
            Log.w("Pdf-Decryptor", "FontBBox missing, returning empty rectangle");
