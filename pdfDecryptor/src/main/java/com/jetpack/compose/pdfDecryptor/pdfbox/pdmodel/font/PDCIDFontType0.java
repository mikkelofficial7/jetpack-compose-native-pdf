...
public class PDCIDFontType0 extends PDCIDFont
{
    ...
    public PDCIDFontType0(COSDictionary fontDictionary, PDType0Font parent) throws IOException
    {
        ...
        if (bytes != null && bytes.length > 0 && (bytes[0] & 0xff) == '%')
        {
            ...
            Log.w("Pdf-Decryptor", "Found PFB but expected embedded CFF font " + fd.getFontName());
            fontIsDamaged = true;
        }
        else if (bytes != null)
        {
            ...
            {
                Log.e("Pdf-Decryptor", "Can't read the embedded CFF font " + fd.getFontName(), e);
                fontIsDamaged = true;
            }
        }
        ...
        else
        {
            ...
            {
                Log.w("Pdf-Decryptor", "Using fallback " + font.getName() + " for CID-keyed font " +
                    getBaseFont());
            }
            isEmbedded = false;
