...
public class PDPageLabels implements COSObjectable
{
     ...
     * {@link com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.PDDocumentCatalog#setPageLabels(PDPageLabels)}.
     * </p>
     *
     * @param document
     *            The document the page label dictionary is created for.
     * @see com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.PDDocumentCatalog#setPageLabels(PDPageLabels)
     */
