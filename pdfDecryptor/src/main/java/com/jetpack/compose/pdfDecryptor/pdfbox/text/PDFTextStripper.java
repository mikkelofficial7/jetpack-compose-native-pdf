...
import com.jetpack.compose.pdfDecryptor.pdfbox.util.IterativeMergeSort;
...
public class PDFTextStripper extends LegacyPDFStreamEngine
{
    ...
    static
    {
        String path = "com/jetpack/compose/pdfDecryptor/pdfbox/resources/text/BidiMirroring.txt";
        ...
        {
            Log.w("Pdf-Decryptor", "Could not parse BidiMirroring.txt, mirroring char map will be empty: "
                + e.getMessage());
        }
        finally
        {
            ...
            {
                Log.e("Pdf-Decryptor", "Could not close BidiMirroring.txt ", e);
            }
        }
    }
