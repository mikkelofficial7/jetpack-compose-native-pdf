...
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.interactive.annotation.PDAnnotationLink;
...
public class Splitter
{
    ...
    protected PDDocument createNewDocument() throws IOException
    {
        ...
        if (sourceDocumentInformation != null)
        {
            ...
            for (COSName key : sourceDocumentInformationDictionary.keySet())
            {
                ...
                {
                    Log.w("Pdf-Decryptor", "Nested entry for key '" + key.getName()
                    ...
                    {
                        Log.w("Pdf-Decryptor", "/Root and /Info share the same dictionary");
                    }
                    continue;
                }
    ...
    protected void processPage(PDPage page) throws IOException
    {
        ...
        if (page.getResources() != null && !page.getCOSObject().containsKey(COSName.RESOURCES))
        {
            ...
            Log.i("Pdf-Decryptor", "Resources imported in Splitter"); // follow-up to warning in importPage
        }
