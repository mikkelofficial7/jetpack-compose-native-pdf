 ...
 */
package com.jetpack.compose.pdfDecryptor.pdfbox.rendering;
...
import com.jetpack.compose.pdfDecryptor.harmony.awt.geom.AffineTransform;
import com.jetpack.compose.pdfDecryptor.pdfbox.contentstream.PDFGraphicsStreamEngine;
...
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.common.function.PDFunction;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.documentinterchange.markedcontent.PDPropertyList;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.font.PDCIDFontType0;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.font.PDCIDFontType2;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.font.PDFont;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.font.PDTrueTypeFont;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.font.PDType0Font;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.font.PDType1CFont;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.font.PDType1Font;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.font.PDType3Font;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.graphics.PDLineDashPattern;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.graphics.PDXObject;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.graphics.blend.BlendMode;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.graphics.color.PDColor;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.graphics.color.PDColorSpace;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.graphics.color.PDDeviceGray;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.graphics.color.PDICCBased;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.graphics.form.PDFormXObject;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.graphics.form.PDTransparencyGroup;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.graphics.image.PDImage;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.graphics.image.PDImageXObject;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.graphics.optionalcontent.PDOptionalContentGroup;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.graphics.optionalcontent.PDOptionalContentGroup.RenderState;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.graphics.optionalcontent.PDOptionalContentMembershipDictionary;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.graphics.shading.PDShading;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.graphics.state.PDExtendedGraphicsState;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.graphics.state.PDGraphicsState;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.graphics.state.PDSoftMask;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.graphics.state.RenderingMode;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.interactive.annotation.AnnotationFilter;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.interactive.annotation.PDAnnotation;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.interactive.annotation.PDAnnotationUnknown;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.interactive.annotation.PDAppearanceDictionary;
import com.jetpack.compose.pdfDecryptor.pdfbox.util.Matrix;
import com.jetpack.compose.pdfDecryptor.pdfbox.util.Vector;
...
//    protected Paint getPaint(PDColor color) throws IOException TODO: PdfBox-Android
        ...
        Vector displacement) throws IOException
    {
        ...
        {
            Log.e("Pdf-Decryptor", "Could not draw glyph for code " + code + " at position (" +
...
//    protected final Paint getNonStrokingPaint() throws IOException TODO: PdfBox-Android
    ...
    private void setStroke()
    {
        ...
        if (miterLimit < 1)
        {
            Log.w("Pdf-Decryptor", "Miter limit must be >= 1, value " + miterLimit + " is ignored");
            miterLimit = 10;
        }
...
//            Paint awtPaint; TODO: PdfBox-Android
    ...
    public void shadingFill(COSName shadingName) throws IOException
    {
        ...
        if (shading == null)
        {
            Log.e("Pdf-Decryptor", "shading " + shadingName + " does not exist in resources dictionary");
            return;
        }
        Matrix ctm = getGraphicsState().getCurrentTransformationMatrix();
...
//            {
//                Log.e("Pdf-Decryptor", "Exception drawing image, see JDK-6689349, " +
...
//            Shape savedInitialClip = initialClip;
            ...
            if (formBBox == null)
            {
                ...
                Log.w("Pdf-Decryptor", "transparency group ignored because BBox is null");
...
//        RectF getBounds()
    ...
    private boolean isHiddenOCMD(PDOptionalContentMembershipDictionary ocmd)
    {
        if (ocmd.getCOSObject().getCOSArray(COSName.VE) != null)
        {
            ...
            Log.i("Pdf-Decryptor", "/VE entry ignored in Optional Content Membership Dictionary");
        }
