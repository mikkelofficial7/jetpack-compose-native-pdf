 ...
 */
package com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.graphics.color;
...
public final class PDICCBased extends PDColorSpace // TODO: PdfBox-Android PDCIEBasedColorSpace
{
    ...
    * {@link PDICCBased#create(com.jetpack.compose.pdfDecryptor.pdfbox.cos.COSArray, com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.PDResources)}
   ...
   private void loadICCProfile() throws IOException
   {
      if (useOnlyAlternateColorSpace)
      {
         ...
         {
            Log.w("Pdf-Decryptor", "Error initializing alternate color space: " + e.getLocalizedMessage());
         }
      }
   }
   ...
   private void fallbackToAlternateColorSpace(Exception e) throws IOException
   {
      ...
      if ( e != null )
      {
         Log.w("Pdf-Decryptor", "Can't read embedded ICC profile (" + e.getLocalizedMessage() +
