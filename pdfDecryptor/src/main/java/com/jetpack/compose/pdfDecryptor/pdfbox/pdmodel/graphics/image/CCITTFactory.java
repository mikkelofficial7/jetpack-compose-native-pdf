...
import com.jetpack.compose.pdfDecryptor.pdfbox.io.RandomAccess;
import com.jetpack.compose.pdfDecryptor.pdfbox.io.RandomAccessBuffer;
import com.jetpack.compose.pdfDecryptor.pdfbox.io.RandomAccessFile;
...
public final class CCITTFactory
{
     ...
     * files you have, use
     * {@link LosslessFactory#createFromImage(com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.PDDocument, android.graphics.Bitmap)}
     * or {@link CCITTFactory#createFromImage(PDDocument, Bitmap) }
     * instead.
     *
     * @param document the document to create the image as part of.
