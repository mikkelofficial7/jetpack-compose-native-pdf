...
import com.jetpack.compose.pdfDecryptor.fontbox.cff.CFFParser;
import com.jetpack.compose.pdfDecryptor.fontbox.cff.CFFType1Font;
...
public class PDType1CFont extends PDSimpleFont
{
    ...
    public PDType1CFont(COSDictionary fontDictionary) throws IOException
    {
        ...
        if (fd != null)
        {
            ...
            if (ff3Stream != null)
            {
                ...
                if (bytes.length == 0)
                {
                    Log.e("Pdf-Decryptor", "Invalid data for embedded Type1C font " + getName());
                    bytes = null;
                }
            }
        }
        ...
        try
        {
            if (bytes != null)
            {
                ...
                {
                    Log.e("Pdf-Decryptor", "Expected CFFType1Font, got " + parsedCffFont.getClass().getSimpleName());
                    fontIsDamaged = true;
                }
            }
        }
        ...
        {
            Log.e("Pdf-Decryptor", "Can't read the embedded Type1C font " + getName(), e);
            fontIsDamaged = true;
        }
    ...
    public float getHeight(int code) throws IOException
    {
        ...
        if (!glyphHeights.containsKey(name))
        {
            if (cffFont == null)
            {
                Log.w("Pdf-Decryptor", "No embedded CFF font, returning 0");
                return 0;
            }
