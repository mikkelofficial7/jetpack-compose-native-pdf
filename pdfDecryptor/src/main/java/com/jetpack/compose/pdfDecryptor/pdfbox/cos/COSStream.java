 ...
 */
package com.jetpack.compose.pdfDecryptor.pdfbox.cos;
...
import com.jetpack.compose.pdfDecryptor.pdfbox.io.RandomAccessOutputStream;
...
public class COSStream extends COSDictionary implements Closeable
{
    ...
    private void ensureRandomAccessExists(boolean forInputStream) throws IOException
    {
        if (randomAccess == null)
        {
            if (forInputStream && PDFBoxConfig.isDebugEnabled())
            {
                ...
                Log.d("Pdf-Decryptor", "Create InputStream called without data being written before to stream.");
            }
    ...
    public String toTextString()
    {
        ...
        {
            Log.d("Pdf-Decryptor", "An exception occurred trying to get the content - returning empty string instead", e);
            return "";
        }
        finally
        {
