...
package com.jetpack.compose.pdfDecryptor.fontbox.util.autodetect;
 ...
 * see com.jetpack.compose.pdfDecryptor.fop.fonts.autodetect.FontFileFinder
 */
    ...
    private void walk(File directory, List<URI> results)
    {
        ...
        for (File file : filelist)
        {
            ...
            else
            {
                ...
                {
                    Log.d("Pdf-Decryptor", "checkFontfile check " + file);
                }
                if (checkFontfile(file))
                {
                    if (PDFBoxConfig.isDebugEnabled())
                    {
                        Log.d("Pdf-Decryptor", "checkFontfile found " + file);
                    }
