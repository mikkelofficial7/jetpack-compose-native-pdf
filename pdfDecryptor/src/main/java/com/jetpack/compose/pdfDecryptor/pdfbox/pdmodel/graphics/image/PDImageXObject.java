 ...
 */
package com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.graphics.image;
...
import com.jetpack.compose.pdfDecryptor.pdfbox.cos.COSInputStream;
...
import com.jetpack.compose.pdfDecryptor.pdfbox.filter.DecodeOptions;
import com.jetpack.compose.pdfDecryptor.pdfbox.filter.DecodeResult;
...
import com.jetpack.compose.pdfDecryptor.pdfbox.util.filetypedetector.FileType;
import com.jetpack.compose.pdfDecryptor.pdfbox.util.filetypedetector.FileTypeDetector;
...
public final class PDImageXObject extends PDXObject implements PDImage
{
    ...
    public static PDImageXObject createFromFileByExtension(File file, PDDocument doc) throws IOException
    {
        ...
        if ("tif".equals(ext) || "tiff".equals(ext))
        {
            ...
            {
                Log.d("Pdf-Decryptor", "Reading as TIFF failed, setting fileType to PNG", ex);
...
//        if (fileType.equals(FileType.PNG)) TODO: PdfBox-Android
    ...
    private float[] extractMatte(PDImageXObject softMask) throws IOException
    {
        ...
        if (base instanceof COSArray)
        {
            ...
            {
                Log.e("Pdf-Decryptor", "Image /Matte entry not long enough for colorspace, skipped");
                return null;
            }
    ...
    public String getSuffix()
    {
        ...
        {
            Log.w("Pdf-Decryptor", "getSuffix() returns null, filters: " + filters);
            return null;
        }
    }
