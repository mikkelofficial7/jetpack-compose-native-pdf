...
import com.jetpack.compose.pdfDecryptor.pdfbox.pdfwriter.COSWriterXRefEntry;
...
public class PDFXRefStream implements PDFXRef
{
     ...
     *
     * @deprecated use {@link #PDFXRefStream(com.jetpack.compose.pdfDecryptor.pdfbox.cos.COSDocument)}
     */
    @Deprecated
