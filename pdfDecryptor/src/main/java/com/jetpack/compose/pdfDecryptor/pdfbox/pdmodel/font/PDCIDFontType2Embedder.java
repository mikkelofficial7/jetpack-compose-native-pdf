...
import com.jetpack.compose.pdfDecryptor.fontbox.ttf.GlyphTable;
import com.jetpack.compose.pdfDecryptor.fontbox.ttf.HorizontalMetricsTable;
import com.jetpack.compose.pdfDecryptor.fontbox.ttf.TrueTypeFont;
import com.jetpack.compose.pdfDecryptor.fontbox.ttf.VerticalHeaderTable;
import com.jetpack.compose.pdfDecryptor.fontbox.ttf.VerticalMetricsTable;
...
final class PDCIDFontType2Embedder extends TrueTypeEmbedder
{
    ...
    private boolean buildVerticalHeader(COSDictionary cidFont) throws IOException
    {
        ...
        if (vhea == null)
        {
            Log.w("Pdf-Decryptor", "Font to be subset is set to vertical, but has no 'vhea' table");
            return false;
        }
