...
public final class OpenTypeScript
{
    ...
    static
    {
        String path = "/com/jetpack/compose/pdfDecryptor/fontbox/resources/unicode/Scripts.txt";
        ...
        {
            Log.w("Pdf-Decryptor", "Could not parse Scripts.txt, mirroring char map will be empty: "
                + e.getMessage());
        }
        finally
        {
            if (input != null)
            {
                ...
                {
                    Log.w("Pdf-Decryptor", "Could not close Scripts.txt");
                }
            }
        }
    }
