...
final class FlateFilter extends Filter
{
        ...
        COSDictionary parameters, int index) throws IOException
    {
        ...
        catch (DataFormatException e)
        {
            ...
            Log.e("Pdf-Decryptor", "FlateFilter: stop reading corrupt stream due to a DataFormatException");
                ...
                while (true)
                {
                    ...
                    catch(DataFormatException exception)
                    {
                        if (dataWritten)
                        {
                            ...
                            Log.w("Pdf-Decryptor", "FlateFilter: premature end of stream due to a DataFormatException");
                            break;
                        }
                        else
                        {
