 ...
 */
package com.jetpack.compose.pdfDecryptor.fontbox.cmap;
...
public class CMapParser
{
    ...
    protected InputStream getExternalCMap(String name) throws IOException
    {
        ...
        {
            return new BufferedInputStream(PDFBoxResourceLoader.getStream("com/jetpack/compose/pdfDecryptor/fontbox/resources/cmap/" + name));
        }

        InputStream resourceAsStream = getClass().getResourceAsStream("/com/jetpack/compose/pdfDecryptor/fontbox/resources/cmap/" + name);
