 ...
 */
package com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.font.encoding;
...
public final class GlyphList
{
    ...
    {
        String path = "com/jetpack/compose/pdfDecryptor/pdfbox/resources/glyphlist/" + filename;
        ...
        try
        {
            while (in.ready())
            {
                ...
                if (line != null && !line.startsWith("#"))
                {
                    ...
                    {
                        Log.w("Pdf-Decryptor", "duplicate value for " + name + " -> " + parts[1] + " " +
            ...
            else if (name.startsWith("uni") && name.length() == 7)
            {
                ...
                try
                {
                    for (int chPos = 3; chPos + 4 <= nameLength; chPos += 4)
                    {
                        ...
                        {
                            Log.w("Pdf-Decryptor", "Unicode character name with disallowed code area: " + name);
                        }
                        else
                        {
                ...
                {
                    Log.w("Pdf-Decryptor", "Not a number in Unicode character name: " + name);
                }
            }
