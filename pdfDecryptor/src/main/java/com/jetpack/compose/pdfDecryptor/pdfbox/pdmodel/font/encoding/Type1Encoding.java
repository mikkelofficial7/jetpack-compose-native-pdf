...
import com.jetpack.compose.pdfDecryptor.fontbox.afm.CharMetric;
...
public class Type1Encoding extends Encoding
{
     ...
     */
    public static Type1Encoding fromFontBox(com.jetpack.compose.pdfDecryptor.fontbox.encoding.Encoding encoding)
    {
