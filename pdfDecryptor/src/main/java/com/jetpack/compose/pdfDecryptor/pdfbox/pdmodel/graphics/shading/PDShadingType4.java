...
import com.jetpack.compose.pdfDecryptor.harmony.javax.imageio.stream.MemoryCacheImageInputStream;
                ...
                try
                {
                    switch (flag)
                    {
                        case 0:
                            ...
                            if (flag != 0)
                            {
                                Log.e("Pdf-Decryptor", "bad triangle: " + flag);
                            }
                        ...
                        case 2:
                            ...
                            if (lastIndex < 0)
                            {
                                Log.e("Pdf-Decryptor", "broken data stream: " + list.size());
                            }
                            else
                            {
                            ...
                            break;
                        default:
                            Log.w("Pdf-Decryptor", "bad flag: " + flag);
                            break;
                    }
                }
                catch (EOFException ex)
