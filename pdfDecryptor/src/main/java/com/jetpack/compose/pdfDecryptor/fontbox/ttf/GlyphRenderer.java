...
class GlyphRenderer
{
    ...
    private void moveTo(Path path, Point point)
    {
        ...
        {
            Log.d("Pdf-Decryptor", "moveTo: " + String.format(Locale.US, "%d,%d", point.x, point.y));
        }
    }
    ...
    private void lineTo(Path path, Point point)
    {
        ...
        if (PDFBoxConfig.isDebugEnabled())
        {
            Log.d("Pdf-Decryptor", "lineTo: " + String.format(Locale.US, "%d,%d", point.x, point.y));
        }
    }
    ...
    private void quadTo(Path path, Point ctrlPoint, Point point)
    {
        ...
        if (PDFBoxConfig.isDebugEnabled())
        {
            Log.d("Pdf-Decryptor", "quadTo: " + String.format(Locale.US, "%d,%d %d,%d", ctrlPoint.x, ctrlPoint.y,
                point.x, point.y));
        }
    }
