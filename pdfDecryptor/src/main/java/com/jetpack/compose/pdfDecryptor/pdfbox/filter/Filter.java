 ...
 */
package com.jetpack.compose.pdfDecryptor.pdfbox.filter;
...
public abstract class Filter
{
     ...
     */
    public static final String SYSPROP_DEFLATELEVEL = "com.jetpack.compose.pdfDecryptor.pdfbox.filter.deflatelevel";
    ...
    protected COSDictionary getDecodeParams(COSDictionary dictionary, int index)
    {
        ...
        {
            Log.e("Pdf-Decryptor", "Expected DecodeParams to be an Array or Dictionary but found " +
...
//    protected static ImageReader findImageReader(String formatName, String errorCause) throws MissingImageReaderException TODO: PdfBox-Android
    ...
    public static int getCompressionLevel()
    {
        ...
        {
            Log.w("Pdf-Decryptor", ex.getMessage(), ex);
        }
