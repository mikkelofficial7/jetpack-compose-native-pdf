...
import com.jetpack.compose.pdfDecryptor.harmony.javax.imageio.stream.MemoryCacheImageOutputStream;
...
import com.jetpack.compose.pdfDecryptor.pdfbox.filter.Filter;
import com.jetpack.compose.pdfDecryptor.pdfbox.filter.FilterFactory;
...
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.graphics.color.PDDeviceColorSpace;
...
public final class LosslessFactory
{
     ...
     * {@link PDImageXObject#setColorSpace(com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.graphics.color.PDColorSpace) PDImageXObject.setColorSpace()}
     *
        ...
        if (usePredictorEncoder)
        {
            ...
            if (pdImageXObject != null)
            {
                    ...
                    image.getWidth() * image.getHeight() <= 50 * 50)
                {
                    ...
                    {
                        Log.e("Pdf-Decryptor", "Return classic");
                        pdImageXObject.getCOSObject().close();
                        return pdImageXObjectClassic;
                    }
                    else
                    {
                        Log.e("Pdf-Decryptor", "Return predictor");
