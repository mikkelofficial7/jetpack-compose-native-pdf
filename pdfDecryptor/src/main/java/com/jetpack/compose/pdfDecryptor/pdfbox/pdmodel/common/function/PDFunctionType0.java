 ...
 */
package com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.common.function;
    ...
    private class Rinterpol
    {
        ...
        private int[][] getSamples()
        {
            if (samples == null)
            {
                ...
                {
                    Log.e("Pdf-Decryptor", "IOException while reading the sample values of this function.", exception);
                }
            }
            return samples;
        }
