    ...
    void read(TrueTypeFont ttf, TTFDataStream data) throws IOException
    {
        ...
        else if (formatType == 2.0f)
        {
            ...
            if (maxIndex >= WGL4Names.NUMBER_OF_MAC_GLYPHS)
            {
                ...
                for (int i = 0; i < nameArray.length; i++)
                {
                    ...
                    {
                        // PDFBOX-4851: EOF
                        Log.w("Pdf-Decryptor", "Error reading names in PostScript table at entry " + i + " of " +
        ...
        else if (formatType == 2.5f)
        {
            ...
            for (int i = 0; i < glyphNames.length; i++)
            {
                ...
                {
                    Log.d("Pdf-Decryptor", "incorrect glyph name index " + index +
        ...
        else if (formatType == 3.0f)
        {
            ...
            Log.d("Pdf-Decryptor", "No PostScript name information is provided for the font " + font.getName());
        }
        initialized = true;
    }
