...
import com.jetpack.compose.pdfDecryptor.fontbox.ttf.CmapSubtable;
import com.jetpack.compose.pdfDecryptor.fontbox.ttf.CmapTable;
import com.jetpack.compose.pdfDecryptor.fontbox.ttf.GlyphData;
import com.jetpack.compose.pdfDecryptor.fontbox.ttf.PostScriptTable;
...
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.font.encoding.BuiltInEncoding;
...
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.font.encoding.MacOSRomanEncoding;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.font.encoding.MacRomanEncoding;
    ...
    public PDTrueTypeFont(COSDictionary fontDictionary) throws IOException
    {
        ...
        if (getFontDescriptor() != null)
        {
            ...
            if (ff2Stream != null)
            {
                ...
                {
                    Log.w("Pdf-Decryptor", "Could not read embedded TTF for font " + getBaseFont(), e);
                    fontIsDamaged = true;
        ...
        if (ttfFont == null)
        {
            ...
            {
                Log.w("Pdf-Decryptor", "Using fallback font '" + ttfFont + "' for '" + getBaseFont() + "'");
            }
        }
        ttf = ttfFont;
        readEncoding();
