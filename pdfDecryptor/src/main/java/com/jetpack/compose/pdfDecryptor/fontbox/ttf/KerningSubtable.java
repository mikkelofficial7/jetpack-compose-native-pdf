...
public class KerningSubtable
{
    ...
    public int[] getKerning(int[] glyphs)
    {
        ...
        {
            Log.w("Pdf-Decryptor", "No kerning subtable data available due to an unsupported kerning subtable version");
        }
        return kerning;
    }
    ...
    private void readSubtable0(TTFDataStream data) throws IOException
    {
        ...
        if (version != 0)
        {
            Log.i("Pdf-Decryptor", "Unsupported kerning sub-table version: " + version);
            return;
        }
        ...
        {
            Log.d("Pdf-Decryptor", "Skipped kerning subtable due to an unsupported kerning subtable version: " + format);
        }
    }
    ...
    {
        Log.i("Pdf-Decryptor", "Kerning subtable format 2 not yet supported.");
    }

    private void readSubtable1(TTFDataStream data)
    {
        Log.i("Pdf-Decryptor", "Kerning subtable format 1 not yet supported.");
    }
