    ...
    private void readWidths()
    {
        ...
        if (wBase instanceof COSArray)
        {
            ...
            while (counter < size - 1)
            {
                ...
                {
                    Log.w("Pdf-Decryptor", "Expected a number array member, got " + firstCodeBase);
                    continue;
                }
                ...
                if (next instanceof COSArray)
                {
                    ...
                    for (int i = 0; i < arraySize; i++)
                    {
                        ...
                        {
                            Log.w("Pdf-Decryptor", "Expected a number array member, got " + widthBase);
                        }
                    }
                }
                else
                {
                    if (counter >= size)
                    {
                        Log.w("Pdf-Decryptor", "premature end of widths array");
                        break;
                    }
                    ...
                    {
                        Log.w("Pdf-Decryptor", "Expected two numbers, got " + secondCodeBase + " and " + rangeWidthBase);
                        continue;
                    }
