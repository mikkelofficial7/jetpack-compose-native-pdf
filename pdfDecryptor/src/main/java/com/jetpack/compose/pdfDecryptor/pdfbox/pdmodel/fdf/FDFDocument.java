...
import com.jetpack.compose.pdfDecryptor.pdfbox.pdfparser.FDFParser;
...
public class FDFDocument implements Closeable
{
    ...
    {
        return new FDFDocument(com.jetpack.compose.pdfDecryptor.pdfbox.util.XMLUtil.parse(input));
    }
