...
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.common.PDPageLabels;
...
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.fixup.AcroFormDefaultFixup;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.fixup.PDDocumentFixup;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.graphics.color.PDOutputIntent;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.graphics.optionalcontent.PDOptionalContentProperties;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.interactive.action.PDActionFactory;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.interactive.action.PDDocumentCatalogAdditionalActions;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.interactive.action.PDURIDictionary;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.interactive.documentnavigation.destination.PDDestination;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.interactive.documentnavigation.destination.PDNamedDestination;
...
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.interactive.pagenavigation.PDThread;
...
public class PDDocumentCatalog implements COSObjectable
{
    ...
    public PDAcroForm getAcroForm(PDDocumentFixup acroFormFixup)
    {
        ...
        {
            Log.d("Pdf-Decryptor", "AcroForm content has already been retrieved with fixes applied - original content changed because of that");
        }
    ...
    public PageLayout getPageLayout()
    {
        ...
        if (mode != null && !mode.isEmpty())
        {
            ...
            {
                Log.w("Pdf-Decryptor", "Invalid PageLayout used '" + mode + "' - returning PageLayout.SINGLE_PAGE", e);
            }
        }
