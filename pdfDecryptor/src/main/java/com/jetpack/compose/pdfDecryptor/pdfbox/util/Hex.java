...
public final class Hex
{
    ...
    public static byte[] decodeBase64(String base64Value)
    {
        ...
        {
            Log.d("Pdf-Decryptor", ex.getMessage(), ex);
        }
        ...
        Log.e("Pdf-Decryptor", "Can't decode base64 value, try adding javax.xml.bind:jaxb-api to your build");
        return new byte[0];
    }
    ...
    public static byte[] decodeHex(String s) throws IOException
    {
        ...
        while (i < s.length() - 1)
        {
            ...
            else
            {
                ...
                {
                    Log.e("Pdf-Decryptor", "Can't parse " + hexByte + ", aborting decode", ex);
                    break;
                }
                i += 2;
            }
