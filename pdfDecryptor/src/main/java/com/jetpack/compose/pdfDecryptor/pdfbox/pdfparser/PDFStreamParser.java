...
public class PDFStreamParser extends BaseParser
{
            ...
            case 'B':
                ...
                if (nextOperator.equals(OperatorName.BEGIN_INLINE_IMAGE))
                {
                    ...
                    while ((nextToken = parseNextToken()) instanceof COSName)
                    {
                        ...
                        {
                            Log.w("Pdf-Decryptor", "Unexpected token in inline image dictionary at offset " +
                    ...
                    if (nextToken instanceof Operator)
                    {
                        ...
                        {
                            Log.w("Pdf-Decryptor", "empty inline image at stream offset "
                                + seqSource.getPosition());
                        }
    ...
    private boolean hasNoFollowingBinData(SequentialSource pdfSource) throws IOException
    {
        ...
        if (!noBinData)
        {
            Log.w("Pdf-Decryptor", "ignoring 'EI' assumed to be in the middle of inline image at stream offset " +
