 ...
 */
package com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.interactive.annotation.handlers;
...
import com.jetpack.compose.pdfDecryptor.fontbox.util.Charsets;
...
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.PDAppearanceContentStream;
...
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.interactive.annotation.PDAnnotationMarkup;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.interactive.annotation.PDAppearanceStream;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.interactive.annotation.PDBorderEffectDictionary;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.interactive.annotation.layout.AppearanceStyle;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.interactive.annotation.layout.PlainText;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.interactive.annotation.layout.PlainTextFormatter;
...
import static com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.interactive.annotation.PDAnnotationLine.LE_NONE;
...
public class PDFreeTextAppearanceHandler extends PDAbstractAppearanceHandler
{
    ...
    private PDColor extractNonStrokingColor(PDAnnotationMarkup annotation)
    {
        ...
        {
            Log.w("Pdf-Decryptor", "Problem parsing /DA, will use default black", ex);
        }
        return strokingColor;
    }
    ...
    private void extractFontDetails(PDAnnotationMarkup annotation)
    {
        ...
        {
            Log.w("Pdf-Decryptor", "Problem parsing /DA, will use default 'Helv 10'", ex);
        }
    }
