...
public abstract class PDAnnotation implements COSObjectable
{
    ...
    public static PDAnnotation createAnnotation(COSBase base) throws IOException
    {
        ...
        if (base instanceof COSDictionary)
        {
            ...
            else
            {
                ...
                Log.d("Pdf-Decryptor", "Unknown or unsupported annotation subtype " + subtype);
            }
        }
        else
        {
    ...
    public PDAnnotation(COSDictionary dict)
    {
        ...
        {
            Log.w("Pdf-Decryptor", "Annotation has type " + type + ", further mayhem may follow");
        }
    }
    ...
    public PDRectangle getRectangle()
    {
        ...
        if (rectArray != null)
        {
            ...
            {
                Log.w("Pdf-Decryptor", rectArray + " is not a rectangle array, returning null");
            }
        }
        return rectangle;
    }
