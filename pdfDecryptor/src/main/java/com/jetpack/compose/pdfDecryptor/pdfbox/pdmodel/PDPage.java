...
import com.jetpack.compose.pdfDecryptor.pdfbox.contentstream.PDContentStream;
...
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.interactive.action.PDPageAdditionalActions;
...
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.interactive.measurement.PDViewportDictionary;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.interactive.pagenavigation.PDThreadBead;
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.interactive.pagenavigation.PDTransition;
...
public class PDPage implements COSObjectable, PDContentStream
{
    ...
    public PDRectangle getMediaBox()
    {
        if (mediaBox == null)
        {
            ...
            {
                Log.d("Pdf-Decryptor", "Can't find MediaBox, will use U.S. Letter");
    ...
    public List<PDViewportDictionary> getViewports()
    {
        ...
        for (int i = 0; i < array.size(); ++i)
        {
            ...
            {
                Log.w("Pdf-Decryptor", "Array element " + base2 + " is skipped, must be a (viewport) dictionary");
            }
        }
        return viewports;
    }
