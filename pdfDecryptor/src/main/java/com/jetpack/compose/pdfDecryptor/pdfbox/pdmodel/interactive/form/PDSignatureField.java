...
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.interactive.digitalsignature.PDSeedValue;
...
public class PDSignatureField extends PDTerminalField
{
    ...
    void constructAppearances() throws IOException
    {
        ...
        if (widget != null)
        {
            ...
            Log.w("Pdf-Decryptor", "Appearance generation for signature fields not implemented here. "
