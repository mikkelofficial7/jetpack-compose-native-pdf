...
import com.jetpack.compose.pdfDecryptor.harmony.awt.AWTColor;
import com.jetpack.compose.pdfDecryptor.harmony.awt.geom.AffineTransform;
import com.jetpack.compose.pdfDecryptor.pdfbox.contentstream.operator.OperatorName;
...
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.graphics.color.PDDeviceCMYK;
...
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.graphics.image.PDInlineImage;
...
import com.jetpack.compose.pdfDecryptor.pdfbox.util.Charsets;
import com.jetpack.compose.pdfDecryptor.pdfbox.util.Matrix;
import com.jetpack.compose.pdfDecryptor.pdfbox.util.NumberFormatUtil;
...
public final class PDPageContentStream implements Closeable
{
    ...
    public PDPageContentStream(PDDocument document, PDPage sourcePage) throws IOException
    {
        ...
        {
            Log.w("Pdf-Decryptor", "You are overwriting an existing content, you should use the append mode");
        }
    }
    ...
    public void transform(Matrix matrix) throws IOException
    {
        if (inTextMode)
        {
            Log.w("Pdf-Decryptor", "Modifying the current transformation matrix is not allowed within text objects.");
        }
    ...
    public void saveGraphicsState() throws IOException
    {
        if (inTextMode)
        {
            Log.w("Pdf-Decryptor", "Saving the graphics state is not allowed within text objects.");
        }
    ...
    public void restoreGraphicsState() throws IOException
    {
        if (inTextMode)
        {
            Log.w("Pdf-Decryptor", "Restoring the graphics state is not allowed within text objects.");
        }
...
//            currentNonStrokingColorSpace instanceof PDPattern ||
    ...
    public void close() throws IOException
    {
        if (inTextMode)
        {
            Log.w("Pdf-Decryptor", "You did not call endText(), some viewers won't display your text");
        }
        if (output != null)
        {
            output.close();
