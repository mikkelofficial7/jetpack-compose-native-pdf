 ...
 */
package com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.interactive.digitalsignature.visible;
...
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.graphics.image.LosslessFactory;
...
public class PDVisibleSigBuilder implements PDFTemplateBuilder
{
    ...
    public PDVisibleSigBuilder()
    {
        ...
        Log.i("Pdf-Decryptor", "PDF Structure has been created");
    }
    ...
    public void createPage(PDVisibleSignDesigner properties)
    {
        ...
        Log.i("Pdf-Decryptor", "PDF page has been created");
    }
    ...
    public void createAcroForm(PDDocument template)
    {
        ...
        Log.i("Pdf-Decryptor", "AcroForm has been created");
    }
    ...
    public void createSignatureField(PDAcroForm acroForm) throws IOException
    {
        ...
        Log.i("Pdf-Decryptor", "Signature field has been created");
    }
        ...
        throws IOException
    {
        ...
        Log.i("Pdf-Decryptor", "PDSignature has been created");
    }
        ...
        throws IOException
    {
        ...
        Log.i("Pdf-Decryptor", "AcroForm dictionary has been created");
    }
        ...
        PDVisibleSignDesigner properties) throws IOException
    {
        ...
        Log.i("Pdf-Decryptor", "Signature rectangle has been created");
    }

    /**
     * {@inheritDoc }
     *
     * @deprecated use {@link #createAffineTransform(com.jetpack.compose.pdfDecryptor.harmony.awt.geom.AffineTransform) }
     */
    @Override
    @Deprecated
    public void createAffineTransform(byte[] params)
    {
        ...
        Log.i("Pdf-Decryptor", "Matrix has been added");
    }
    ...
    public void createProcSetArray()
    {
        ...
        Log.i("Pdf-Decryptor", "ProcSet array has been created");
    }
    ...
    public void createSignatureImage(PDDocument template, Bitmap image) throws IOException
    {
        ...
        Log.i("Pdf-Decryptor", "Visible Signature Image has been created");
    }
    ...
    public void createFormatterRectangle(byte[] params)
    {
        ...
        Log.i("Pdf-Decryptor", "Formatter rectangle has been created");
    }
    ...
    public void createHolderFormStream(PDDocument template)
    {
        ...
        Log.i("Pdf-Decryptor", "Holder form stream has been created");
    }
    ...
    public void createHolderFormResources()
    {
        ...
        Log.i("Pdf-Decryptor", "Holder form resources have been created");
        ...
        PDRectangle bbox)
    {
        ...
        Log.i("Pdf-Decryptor", "Holder form has been created");
        ...
        PDSignatureField signatureField) throws IOException
    {
        ...
        Log.i("Pdf-Decryptor", "PDF appearance dictionary has been created");
    }
    ...
    public void createInnerFormStream(PDDocument template)
    {
        ...
        Log.i("Pdf-Decryptor", "Stream of another form (inner form - it will be inside holder form) " +
            "has been created");
    }
    ...
    public void createInnerFormResource()
    {
        ...
        Log.i("Pdf-Decryptor", "Resources of another form (inner form - it will be inside holder form)" +
            "have been created");
    }
        ...
        PDRectangle bbox)
    {
        ...
        Log.i("Pdf-Decryptor", "Another form (inner form - it will be inside holder form) has been created");
    }
        ...
        PDResources holderFormResources)
    {
        ...
        Log.i("Pdf-Decryptor", "Now inserted inner form inside holder form");
    }
    ...
    public void createImageFormStream(PDDocument template)
    {
        ...
        Log.i("Pdf-Decryptor", "Created image form stream");
    }
    ...
    public void createImageFormResources()
    {
        ...
        Log.i("Pdf-Decryptor", "Created image form resources");
    }
        ...
        PDImageXObject img) throws IOException
    {
        ...
        Log.i("Pdf-Decryptor", "Created image form");
    }
        ...
        throws IOException
    {
        ...
        Log.i("Pdf-Decryptor", "Created background layer form");
    }
        ...
        PDResources holderFormResources, COSArray procSet)
    {
        ...
        Log.i("Pdf-Decryptor", "Inserted ProcSet to PDF");
    }
        ...
        PDVisibleSignDesigner properties) throws IOException
    {
        ...
        Log.i("Pdf-Decryptor", "Injected appearance stream to pdf");
    }
    ...
    public void createVisualSignature(PDDocument template)
    {
        ...
        Log.i("Pdf-Decryptor", "Visible signature has been created");
    }
        ...
        PDResources holderFormResources) throws IOException
    {
        ...
        Log.i("Pdf-Decryptor", "WidgetDictionary has been created");
    }
