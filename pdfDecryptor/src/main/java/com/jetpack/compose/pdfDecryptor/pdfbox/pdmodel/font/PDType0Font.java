...
public class PDType0Font extends PDFont implements PDVectorFont
{
    ...
    private void readEncoding() throws IOException
    {
        ...
        else if (encoding != null)
        {
            ...
            {
                Log.w("Pdf-Decryptor", "Invalid Encoding CMap in font " + getName());
            }
        }
    ...
    private void fetchCMapUCS2() throws IOException
    {
            ...
            isDescendantCJK)
        {
            ...
            if (strName != null)
            {
                ...
                {
                    Log.w("Pdf-Decryptor", "Could not get " + strName + " UC2 map for font " + getName(), ex);
                }
            }
        }
    }
    ...
    public String toUnicode(int code) throws IOException
    {
        ...
        if (descendantFont instanceof PDCIDFontType2)
        {
            ...
            if (font != null)
            {
                ...
                {
                    Log.w("Pdf-Decryptor", "get unicode from font cmap fail", e);
                }
            }
        }
        ...
        if (!noUnicode.contains(code))
        {
            ...
            Log.w("Pdf-Decryptor", "No Unicode mapping for " + cid + " (" + code + ") in font " + getName());
