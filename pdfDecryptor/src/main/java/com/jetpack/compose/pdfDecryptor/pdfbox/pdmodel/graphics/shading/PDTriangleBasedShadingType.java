 ...
 */
package com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.graphics.shading;
...
import com.jetpack.compose.pdfDecryptor.harmony.javax.imageio.stream.ImageInputStream;
...
import com.jetpack.compose.pdfDecryptor.pdfbox.pdmodel.common.PDRange;
...
abstract class PDTriangleBasedShadingType extends PDShading
{
    ...
    public int getBitsPerComponent()
    {
        if (bitsPerColorComponent == -1)
        {
            ...
            Log.d("Pdf-Decryptor", "bitsPerColorComponent: " + bitsPerColorComponent);
        }
    ...
    public int getBitsPerCoordinate()
    {
        if (bitsPerCoordinate == -1)
        {
            ...
            Log.d("Pdf-Decryptor", "bitsPerCoordinate: " + (Math.pow(2, bitsPerCoordinate) - 1));
        }
    ...
    public int getNumberOfColorComponents() throws IOException
    {
        if (numberOfColorComponents == -1)
        {
            ...
            Log.d("Pdf-Decryptor", "numberOfColorComponents: " + numberOfColorComponents);
        }
        ...
        Matrix matrix, AffineTransform xform) throws IOException
    {
        ...
        Log.d("Pdf-Decryptor", "coord: " + String.format("[%06X,%06X] -> [%f,%f]", x, y, dstX, dstY));
        ...
        for (int n = 0; n < numberOfColorComponents; ++n)
        {
            ...
            Log.d("Pdf-Decryptor", "color[" + n + "]: " + color + "/" + String.format("%02x", color)
